  ...
  return (
    <div className="ml-[70px]">
          ...
          {searchActive ? (
            <div className="absolute top-10 w-[90vw] bg-white min-h-[90vh] border-2 border-black">
              <div className="flex items-center justify-between shadow-lg border border-black bg-primary ">
                <p className="text-lg font-semibold text-white pl-2">Search Results:</p>
              ...
              <div
                        ...
                        className="w-full  flex items-center justify-around  h-11 "
                      >
                ...
                {products?.map((product) => {
                  return (
                    <Link key={product?._id} to={`/admin/update/${product?._id}`}>
                      <div
                        
                        className="w-full  flex items-center justify-around py-1  h-11 hover:text-white hover:bg-red-500 transition-all ease-in duration-200 border-t border-b border-black"
                      >
                        <img className="h-full w-8" src={product?.images[0]?.url} alt="" />
                        <p>{product?.name}</p>
                        <p>{product?.price}</p>
                        <p>{product?.rating}</p>
                      </div>
      ...
      <div className="w-full   flex">
        <div className="w-1/6 border-t border-r h-[100vh] border-black px-3">
