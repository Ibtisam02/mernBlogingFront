...
function AdminHome() {
  ...
  let { pendingOrdersCount } = useSelector((state) => state.pendingOrdersCount);
      ...
      <div className="mt-5 flex flex-wrap h-[50vh] gap-4 justify-center">
        ...
        <div className="w-full bg-orange-500 h-[47%] px-5 py-4 flex ">
          <div className="w-1/2 flex flex-col justify-around">
            ...
            <p className="text-center text-2xl text-white">
              {pendingOrdersCount || <FadeLoader  color="#ffffff" radius={0} height={6} width={20} />}
            </p>
          </div>
        ...
        <div className="w-full bg-pink-500 h-[47%]  px-5 py-4 flex ">
          <div className="w-1/2 flex flex-col justify-around">
            ...
            <p className="text-center text-2xl text-white">
              {lowStockProductsCount || <FadeLoader  color="#ffffff" radius={0} height={6} width={20} />}
            </p>
          </div>
          <div className="w-1/2 flex justify-center items-center">
      ...
      <div className="flex justify-center items-center flex-wrap gap-3 my-5">
        <div className="w-1/5 bg-purple-500 h-fit px-5 py-4 flex ">
          <div className="w-1/2 flex flex-col justify-around">
            ...
            <p className="text-center text-2xl text-white">
              {usersCount || <FadeLoader  color="#ffffff" radius={0} height={6} width={20} />}
            </p>
          </div>
          <div className="w-1/2 flex justify-center items-center">
        ...
        <div className="w-1/5 bg-red-500 h-fit px-5 py-4 flex">
          <div className="w-1/2 flex flex-col justify-around">
            ...
            <p className="text-center text-2xl text-white">
              {productsCount || <FadeLoader  color="#ffffff" radius={0} height={6} width={20} />}
            </p>
          </div>
          <div className="w-1/2 flex justify-center items-center">
        ...
        <div className="w-1/5 bg-green-500 h-fit px-5 py-4 flex">
          <div className="w-1/2 flex flex-col justify-around">
            ...
            <p className="text-center text-2xl text-white">
              {ordersCount || <FadeLoader  color="#ffffff" radius={0} height={6} width={20} />}
            </p>
          </div>
          <div className="w-1/2 flex justify-center items-center">
        ...
        <div className="w-1/5 bg-blue-500 h-fit px-5 py-4 flex">
          <div className="w-1/2 flex flex-col justify-around">
            ...
            <p className="text-center text-2xl text-white">
              {deliveredOrdersCount || <FadeLoader  color="#ffffff" radius={0} height={6} width={20} />}
            </p>
          </div>
          <div className="w-1/2 flex justify-center items-center">
