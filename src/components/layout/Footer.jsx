  ...
  return (
    <footer className='bg-yellow w-screen flex justify-around items-center bg-slate-800 py-5'>
        <div className='flex flex-col items-center w-[25%]'>
            ...
            <p className='text-white text-center'>Download App for Android and IOS mobile phone</p>
        ...
        <div className='flex flex-col gap-y-3 items-center w-[25%]'>
            ...
            <a href="https://www.instagram.com/?hl=en"><img src={instaLogo} className='h-7' alt="" /></a>
            <a href="#"><img src={ytLogo} className='h-7' alt="" /></a>
            <a href="https://web.facebook.com/ibtisam.ibtisam.773981" target='_blank'><img src={fbLogo} className='h-7' alt="" /></a>
